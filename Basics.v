...
Fixpoint bin_to_nat (b : bin) : nat :=
  match b with
    ...
    | OneTwice b =>  1 + 2 * (bin_to_nat b)
  end.

Example test_bin_to_nat0: bin_to_nat (Twice Z) = 0.
Proof. reflexivity. Qed.
Example test_bin_to_nat1: bin_to_nat (OneTwice Z) = 1.
Proof. reflexivity. Qed.
Example test_bin_to_nat2: bin_to_nat (Twice (OneTwice Z)) = 2.
Proof. reflexivity. Qed.
Example test_bin_to_nat3: bin_to_nat (OneTwice (OneTwice Z)) = 3.
Proof. reflexivity. Qed.
